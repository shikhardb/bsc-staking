  ...
  return (
    ...
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <StyledInternalLink to={`/wazirx/${currencyId(currency0)}/${currencyId(currency1)}/${stakingInfo.index}`} style={{ width: '100%' }}>
      ...
      <StatContainer>
        <RowBetween>
          <TYPE.white> Total deposited Pool Tokens</TYPE.white>
          <TYPE.white>
            {stakedToken}
          </TYPE.white>
        </RowBetween>
        <RowBetween>
          ...
          <TYPE.white>{`${stakingInfo.totalRewardRate
            ?.multiply(`${60 * 60 * 24}`)
            ?.toFixed(0, { groupSeparator: ',' })} WRX / day`}</TYPE.white>
        </RowBetween>
        <RowBetween>
        ...
        <RowBetween>
          <TYPE.white> Pool </TYPE.white>
          <ExternalLink href={`http://3.238.21.51/#/pool/${stakingInfo.wpt}`} >
          <ButtonPrimary padding="8px" borderRadius="8px">
            <TYPE.white>Add Liquidity</TYPE.white>
          </ButtonPrimary>
        </ExternalLink>
          ...
          <BottomSection showBackground={true}>
            ...
            <TYPE.black style={{ textAlign: 'right' }} color={'white'} fontWeight={500}>
              ...
              {`${stakingInfo.rewardRate
                ?.multiply(`${60 * 60 * 24}`)
                ?.toSignificant(4, { groupSeparator: ',' })} WRX / day`}
            </TYPE.black>
          </BottomSection>
        </>
      )}
